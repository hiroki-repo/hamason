...
top:d-5,left:e-5})),this.fire("move",this)):this.mgrPos?(b.setStyle("top",5),b.setStyle("left",5),a.setExpandMode(!1,{top:d-5,left:e-5})):(b.setStyle("top",null),b.setStyle("left",null),a.setExpandMode(!1))}},renderBrand:function(){return'<div class="brand">'+this.renderBrandLogo()+(this.policyUrl?'<a class="brand-notice" href="'+this.policyUrl+'" target="_blank">'+(this.policyText?this.policyText:$tr("app.common.policyText"))+"</a>":"")+"</div>"},renderBrandLogo:function(){return"white_label"===this.logoSrc?"":this.logoSrc?'<a class="brand-logo brand-logo-img" href="'+this.logoUrl+'" target="_blank"><img src="'+this.logoSrc+'"/></a>':this.brandText?'<span class="brand-logo">'+this.brandText+"</span>":void 0}}),miwo.define("App.view.FormPanel",{Extends:App.view.Panel,Implements:[Miwo.utils.Maskable,Miwo.utils.Translatable],title:"",notice:"",hideable:!0,beforeInit:function(){this.parent(),this.frameManage=!0,this.visible=!1,this.width=260,this.height=400,this.componentCls="panel panel-offline";
...
transcriptSendedTitle:"تم إرسال البريد بنجاح"},login:{title:"تسجيل الدخول",messageLabel:"سؤالك",submit:"ابدأ المحادثة"},offline:{title:"ارسل لنا رساله",notice:"نحن غير متواجدين في الوقت الراهن، ولكن يمكنك ترك لنا رسالة. وسوف نقوم بالرد في أقرب وقت ممكن.",hideTitle:"إخفاء المحادثة",name:"ألاسم",email:"الأيميل",message:"رسالتك",submit:"ارسل رساله",messageRequiredAlert:"لم تقم بكتابه الرساله",emailRequiredAlert:"لم تقم بكتابه البريد",emailInvalidAlert:"بريد خاطئ",sendInfo:"جارى إرسال البريد ...",successTitle:"شكرا لك لرسالتك ",successDesc:"تم ارسال رسالتك بنجاح. سوف نتصل بك قريبا.",failureTitle:"خطأ",failureDesc:"لم يتم إرسال رسالتك",number:"رقم الهاتف"},widget:{online:"متصل",away:"بعيدا",offline:"غير متصل"},banner:{bubble:{text:"نحن جاهزون للرد على أسألتك "},arrow:{title:"أى سؤال ؟",desc:"نحن جاهزون للرد"}},button:{title:"محادثة مباشرة"}}),Locale.inherit("ar","en"),Locale.define("cn","app",{messages:{agentjoin:"<strong>{name}</strong> 加入对话.",agentleave:"<strong>{name}</strong> 离开.",transfer:"对话正在被转移至 <b>{name}</b>"
},dialogClose:{title:"是否结束对话?",yes:"是",no:"否",send:"是，发送对话记录到我邮箱"},dialogSend:{title:"发送对话记录到我邮箱",email:"邮箱地址",yes:"发送",no:"取消"},dialogRating:{title:"给对话评分",cancel:"Don't rate"},online:{title:"支持",infoTitle:"Live chat",infoDesc:"需要帮助？",maximize:"最大化",minimize:"最小化",hideTitle:"隐藏对话",closeTitle:"关闭对话",settingsTitle:"设置",disableSounds:"静音",enableSounds:"开启音量",visitor:"我",send:"发送",textareaPlaceholder:"从这里开始输入, 按回车键发送",typingMsg:"<span>{name}</span>正在输入...",transcriptSendingTitle:"邮件已发送...",transcriptSendingDesc:"",transcriptSendedTitle:"邮件已成功发送",transcriptSendedDesc:""},login:{title:"Chat login",messageLabel:"Your question",submit:"Start chat"},offline:{title:"给我们发信息",notice:"系统繁忙, 请留下您的信息. 我们会尽快回复.",hideTitle:"隐藏对话",name:"姓名",email:"邮箱",message:"您的信息",submit:"发送信息",messageRequiredAlert:"您没有输入信息.",emailRequiredAlert:"您没有输入邮箱地址.",emailInvalidAlert:"错误的邮箱地址",sendInfo:"邮件正在发送...",successTitle:"感谢您的信息!",successDesc:"您的信息已成功发送. 我们会尽快联系您.",failureTitle:"发送错误.",failureDesc:"对不起，您的信息发送失败."},widget:{
online:"请输入任何问题",away:"请输入任何问题",offline:"请留言"},banner:{bubble:{text:"准备好了，请提问吧!"},arrow:{title:"有什么问题吗?",desc:"我们已经准备好回答了."}},button:{title:"支持"}}),Locale.inherit("cn","en"),Locale.define("cs","app",{messages:{agentjoin:"{name} se připojil(a) do chatu",agentleave:"{name} se odpojil(a) z chatu",transfer:"Chat byl přesměrován na {name}",rating:"Chat byl ohodnocen"},dialogClose:{title:"Přejete si ukončit chat?",yes:"Ano",no:"Ne",send:"Ano, a zaslat kopii na můj email"},dialogSend:{title:"Odeslat chat na e-mail",email:"E-mail",yes:"Odeslat",no:"Zrušit"},dialogRating:{title:"Ohodnoťte práci operátora",cancel:"Nechci hodnotit",submit:"Odeslat",commentTitle:"Váš komentář"},online:{title:"Podpora",infoTitle:"Live chat",infoDesc:"Zeptejte se nás na cokoliv",maximize:"Zvětšit okno",minimize:"Zmenšit okno",hideTitle:"Skrýt chat",closeTitle:"Ukončit chat",settingsTitle:"Nastavení",disableSounds:"Vypnout zvuky",enableSounds:"Zapnout zvuky",visitor:"Já",send:"Odeslat",textareaPlaceholder:"Pište zde, pro odeslání stiskněte <enter>",
typingMsg:"<span>{name}</span> píše...",transcriptSendingTitle:"E-mail se odesílá...",transcriptSendingDesc:"",transcriptSendedTitle:"E-mail byl úspěšně odeslán",transcriptSendedDesc:"",rate:"Ohodnoťte operátora"},login:{title:"Přihlášení do chatu",messageLabel:"Váš dotaz",submit:"Začít chat"},offline:{title:"Napište nám zprávu",notice:"Nejsme zrovna k dispozici. Zanechte nám zprávu a my se vám ozveme.",hideTitle:"Skrýt chat",required:"",name:"Jméno",email:"E-mail",number:"Telefon",message:"Napište nám zprávu",submit:"Odeslat",messageRequiredAlert:"Nezadali jste žádnou zprávu.",emailRequiredAlert:"Nezadali jste e-mail.",emailInvalidAlert:"Neplatný e-mail.",sendInfo:"E-mail se odesílá...",successTitle:"Děkujeme za váš dotaz",successDesc:"Váš dotaz byl úspěšně odeslán. V blízké době vás budeme kontaktovat.",failureTitle:"Chyba při odesílání",failureDesc:"Je nám líto, ale váš dotaz se nepodařilo odeslat."},widget:{online:"Jsme online",away:"Zrovna tu nejsme",offline:"Napište nám zprávu"},banner:{
bubble:{text:"Máte dotazy? Rádi vám poradíme"},arrow:{title:"Máte dotazy?",desc:"Rádi vám poradíme"}},button:{title:"Podpora"},events:{visitorSendMessageAction:"Návštěvník napsal zprávu",visitorSendMessageLabel:"návštěvník napsal zprávu",operatorSendMessageAction:"Operátor napsal zprávu",operatorSendMessageLabel:"{name} napsal(a) zprávu",triggerSendMessageAction:"Trigger napsal zprávu",triggerSendMessageLabel:"trigger {trigger} napsal",visitorReplyTriggerAction:"Návštěvník odpověděl na trigger",visitorReplyTriggerLabel:"návštěvník odpověděl na trigger {trigger}",conversationByOperatorAction:"Konverzace",conversationByOperatorLabel:"{name} zahájil(a) chat",conversationByVisitorAction:"Konverzace",conversationByVisitorLabel:"návštěvník zahájil chat s {name}",conversationByTriggerAction:"Konverzace",conversationByTriggerLabel:"{name} chatoval(a) pomocí triggeru",closeChatAction:"Ukončení chatu",closeChatLabel:"{type}"}}),Locale.inherit("cs","en"),Locale.define("da","app",{messages:{agentjoin:"{name} loggede på",
agentleave:"{name} loggede af",transfer:"Samtalen er overført til {name}"},dialogClose:{title:"Vil du afslutte chatten?",yes:"Ja",no:"Nej",send:"Ja, og send samtalen til e-mail"},dialogSend:{title:"Send samtalen til e-mail",email:"E-mail",yes:"Send",no:"Annuller"},dialogRating:{title:"Vurdér samtalen med supporteren",cancel:"Undlad at stemme",submit:"Send"},online:{title:"Support",infoTitle:"Live chat",infoDesc:"Spørg os",maximize:"Maksimer",minimize:"Minimer",hideTitle:"Skjul chat",closeTitle:"Luk chat",settingsTitle:"Indstillinger",disableSounds:"Slå lyde fra",enableSounds:"Slå lyde til",visitor:"Mig",send:"Send",textareaPlaceholder:"Skriv her, tryk <enter> for at sende",typingMsg:"<span>{name}</span> skriver...",transcriptSendingTitle:"E-mail sendt...",transcriptSendingDesc:"",transcriptSendedTitle:"E-mailen blev succesfuldt sendt",transcriptSendedDesc:""},login:{title:"Chat login",messageLabel:"Dit spørgsmål",submit:"Start chat"},offline:{title:"Send os en besked",notice:"Vi er desværre ikke online i øjeblikket, men læg en besked til os og vi vender tilbage hurtigst muligt.",
hideTitle:"Skjul chat",name:"Navn",email:"E-mail",message:"Din besked",submit:"Send besked",messageRequiredAlert:"Du har ikke skrevet en besked",emailRequiredAlert:"Du har ikke skrevet en e-mail",emailInvalidAlert:"Ugyldig e-mail adresse",sendInfo:"E-mail bliver sendt...",successTitle:"Tak for din besked",successDesc:"Din e-mail blev succesfuldt sendt. Vi kontakter dig hurtigst muligt.",failureTitle:"Fejl under afsendelse.",failureDesc:"Vi beklager! Der skete en fejl under afsendelse af beskeden.",number:"Telefon"},widget:{online:"Online",away:"Away",offline:"Offline"},banner:{bubble:{text:"Vi er klar til at modtage dine spørgsmål!"},arrow:{title:"Nogle spørgsmål?",desc:"Vi er klar til at svare"}},button:{title:"hjælp"},events:{visitorSendMessageAction:"Besøgende har sendt en besked",visitorSendMessageLabel:"besøgende har sendt en besked"}}),Locale.inherit("da","en"),Locale.define("de","app",{messages:{agentjoin:"{name} hat Chat betreten",agentleave:"{name} hat Chat verlassen",transfer:"Chat an {name} übertragen",
rating:"Chat wurde bewertet"},dialogClose:{title:"Möchten Sie Chat beenden?",yes:"Ja",no:"Nein",send:"Ja, und Chat an E-Mail senden"},dialogSend:{title:"Chat an E-Mail senden",email:"E-Mail",yes:"Senden",no:"Abbrechen"},dialogRating:{title:"Wie würden Sie den Chat bewerten?",cancel:"Ich will keine Bewertung abgeben",submit:"Senden",commentTitle:"Ihr Kommentar"},online:{title:"Support",infoTitle:"Live-Chat",infoDesc:"Ihre Frage?",maximize:"Maximieren",minimize:"Minimieren",hideTitle:"Chat ausblenden",closeTitle:"Chat schließen",settingsTitle:"Einstellungen",disableSounds:"Klänge deaktivieren",enableSounds:"Klänge aktivieren",visitor:"Ich",send:"Senden",textareaPlaceholder:"Hier schreiben, zum Absenden <enter> eingeben",typingMsg:"{name} schreibt...",transcriptSendingTitle:"Sending email...",transcriptSendedTitle:"E-Mail zugesandt",rate:"Bewerten Sie Ihren Agenten"},offline:{title:"Senden Sie uns eine Nachricht",notice:"Wir sind momentan nicht verfügbar. Hinterlassen Sie eine Nachricht, wir melden uns bei Ihnen frühestmöglich.",
hideTitle:"Chat ausblenden",required:"",name:"Name",email:"E-Mail",message:"Ihre Nachricht",submit:"Nachricht senden",messageRequiredAlert:"Sie haben keine Nachricht eingegeben",emailRequiredAlert:"Sie haben keine E-Mail-Adresse eingegeben",emailInvalidAlert:"Ungültige E-Mail-Adresse",sendInfo:"E-Mail wird versendet",successTitle:"Vielen Dank für Ihre Nachricht",successDesc:"Ihre Nachricht wurde an unser Team gesendet. Wir werden uns schnellstmöglich bei Ihnen melden.",failureTitle:"Fehler",failureDesc:"Die Versendung der Nachricht ist fehlgeschlagen",number:"Telefonnummer"},widget:{online:"Online",away:"Abwesend",offline:"Offline"},banner:{bubble:{text:"Wir stehen für Ihre Fragen zur Verfügung"},arrow:{title:"Haben Sie Fragen?",desc:"Sprechen Sie uns an"}},button:{title:"Support"},login:{title:"Chat-Login",messageLabel:"Ihre Frage",submit:"Chat starten"}}),Locale.inherit("de","en"),Locale.define("en","app",{messages:{agentjoin:"{name} joined chat",agentleave:"{name} left chat",transfer:"Chat transferred to {name}",
rating:"Chat was rated"},dialogClose:{title:"Would you like to end chat?",yes:"Yes",no:"No",send:"Yes, and send chat to email"},dialogSend:{title:"Send chat to email",email:"Email",yes:"Send",no:"Cancel"},dialogRating:{title:"How would you rate the chat?",cancel:"I don't want to rate",submit:"Send",commentTitle:"Your comment"},online:{title:"Support",infoTitle:"Live chat",infoDesc:"Ask us anything",maximize:"Maximize",minimize:"Minimize",hideTitle:"Hide chat",closeTitle:"Close chat",settingsTitle:"Settings",disableSounds:"Disable sounds",enableSounds:"Enable sounds",visitor:"Me",send:"Send",rate:"Rate your agent",textareaPlaceholder:"Write here, press <enter> to send",typingMsg:"{name} is typing...",transcriptSendingTitle:"Sending email...",transcriptSendingDesc:"",transcriptSendedTitle:"Email sent",transcriptSendedDesc:""},login:{title:"Chat login",notice:"",messageLabel:"Your question",submit:"Start chat"},offline:{title:"Send us a message",notice:"We are not available at the moment, but you can leave us a message. We will respond as soon as possible.",
hideTitle:"Hide chat",required:"",name:"Name",email:"Email",number:"Phone number",message:"Your message",submit:"Send message",messageRequiredAlert:"You have not entered a message",emailRequiredAlert:"You have not entered an email",emailInvalidAlert:"Invalid email",sendInfo:"Sending email...",successTitle:"Thank you for your message",successDesc:"Your message was sent successfully. We will contact you soon.",failureTitle:"Error",failureDesc:"Your message wasn't sent"},widget:{online:"Online",away:"Away",offline:"Offline"},banner:{bubble:{text:"We are ready for your questions"},arrow:{title:"Any questions?",desc:"We are ready to answer"}},button:{title:"Live chat"},events:{visitorSendMessageAction:"Visitor sent a message",visitorSendMessageLabel:"visitor sent a message",operatorSendMessageAction:"Agent sent a message",operatorSendMessageLabel:"{name} sent a message",triggerSendMessageAction:"Trigger sent",triggerSendMessageLabel:"trigger {trigger} wrote",visitorReplyTriggerAction:"Visitor replied to a trigger",
visitorReplyTriggerLabel:"visitor replied to a trigger {trigger}",conversationByOperatorAction:"Conversation",conversationByOperatorLabel:"{name} started a chat",conversationByVisitorAction:"Conversation",conversationByVisitorLabel:"visitor started a chat with {name}",conversationByTriggerAction:"Conversation",conversationByTriggerLabel:"{name} was chatting by a trigger",closeChatAction:"Close chat",closeChatLabel:"{type}"}}),Locale.define("es","app",{messages:{agentjoin:"{name} unido a chat",agentleave:"{name} dejado chat",transfer:"Chat se transfirió a {name}",rating:"Chat ha sido evaluado"},dialogClose:{title:"¿Quieres terminar chat?",yes:"Sí",no:"No",send:"Sí, y enviar chat a email"},dialogSend:{title:"Enviar chat a email",email:"Email",yes:"Enviar",no:"Cancelar"},dialogRating:{title:"Evaluar chat con agente",cancel:"No evaluar",submit:"Enviar",commentTitle:"Tu comentario"},online:{title:"Apoyo",infoTitle:"Chat en vivo",infoDesc:"Pregúntanos cualquier cosa",maximize:"Maximizar",minimize:"Minimizar",
hideTitle:"Ocultar chat",closeTitle:"Cerrar chat",settingsTitle:"Configuraciones",disableSounds:"Desactivar sonidos",enableSounds:"Activar sonidos",visitor:"Yo",send:"Enviar",textareaPlaceholder:"Escribe aquí, presione <enter> para enviar",typingMsg:"{name} escribiendo...",transcriptSendingTitle:"Email está siendo enviado...",transcriptSendingDesc:"",transcriptSendedTitle:"Email fue enviado",transcriptSendedDesc:"",rate:"Evaluar agente"},offline:{title:"Envíanos un mensaje",notice:"No estamos disponibles en el momento, pero puedes dejarnos un mensaje. Te responderemos tan pronto como sea posible.",hideTitle:"Ocultar chat",required:"",name:"Nombre",email:"Email",message:"Tu mensaje",submit:"Enviar",messageRequiredAlert:"No has introducido ningún mensaje",emailRequiredAlert:"No has introducido ningún email",emailInvalidAlert:"Email inválido",sendInfo:"Email está siendo enviado...",successTitle:"Gracias por tu mensaje",successDesc:"Email fue enviado de manera exitosa. Pronto te contactaremos.",
failureTitle:"Error",failureDesc:"Envío ha fallado",number:"Número de teléfono"},widget:{online:"En línea",away:"Ausente",offline:"Fuera de línea"},banner:{bubble:{text:"Estamos listos para tus preguntas"},arrow:{title:"¿Alguna pregunta?",desc:"Listos para responderte"}},button:{title:"Chat en vivo"},login:{title:"Chat login",messageLabel:"Tu pregunta",submit:"Iniciar chat"}}),Locale.inherit("es","en"),Locale.define("fa","app",{messages:{agentjoin:"{name} به گفتگو پیوست",agentleave:"{name} گفتگو را ترک کرد",transfer:"ادامه گفتگو به {name} سپرده شد"},dialogClose:{title:"قصد پایان دادن به گفتگو را دارید ؟",yes:"بله",no:"خیر",send:"بله ، به همراه ارسال گفتگو به ایمیل من"},dialogSend:{title:"ارسال گفتگو به ایمیل شما",email:"آدرس ایمیل",yes:"ارسال",no:"لغو"},dialogRating:{title:"به این گفتگو امتیاز می دهید ؟",cancel:"تمایلی به امتیازدهی ندارم !",submit:"ارسال",commentTitle:"نظر شما"},online:{title:"پشتیبانی",infoTitle:"گفتگو آنلاین",infoDesc:"سوال خود را مطرح کنید",maximize:"بزرگ کردن",minimize:"کوچک کردن",
hideTitle:"مخفی کردن گفتگو",closeTitle:"مخفی کردن",settingsTitle:"تنظیمات",disableSounds:"غیرفعال کردن صداها",enableSounds:"فعال کردن صداها",visitor:"من",send:"ارسال",textareaPlaceholder:"متن خود را وارد کنید سپس کلید enter را لمس کنید",typingMsg:"{name} در حال نوشتن است ...",transcriptSendingTitle:"درحال ارسال ایمیل ...",transcriptSendedTitle:"ایمیل با موفقیت ارسال شد"},login:{title:"ورود به چت",messageLabel:"سوال شما ؟",submit:"شروع گفتگو"},offline:{title:"ارسال پیام",notice:"متاسفانه کارشناسان ما در دسترس نیستند ! لطفا  پیام خود را ارسال کنید ، کارشناسان به زودی پاسخگو خواهند بود",hideTitle:"مخفی کردن",name:"نام",email:"آدرس ایمیل",message:"پیام شما",submit:"ارسال پیام",messageRequiredAlert:"لطفا پیام خود را وارد کنید !",emailRequiredAlert:"لطفا آدرس ایمیل خود را وارد کنید !",emailInvalidAlert:"آدرس ایمیل معتبر نیست",sendInfo:"در حال ارسال ...",successTitle:"از تماس شما متشکریم",successDesc:"پیام شما ارسال شد ، منتظر پاسخ کارشناسان ما باشید",failureTitle:"خطایی رخ داده !",failureDesc:"پیام شما ارسال نشد",
number:"تلفن تماس"},widget:{online:"آنلاین",away:"مشغول",offline:"آفلاین"},banner:{bubble:{text:"آماده پاسخگویی به شما هستیم"},arrow:{title:"سوالی دارید ؟",desc:"لطفا بپرسید"}},button:{title:"گفتگو آنلاین"},events:{triggerSendMessageLabel:"\n"}}),Locale.inherit("fa","en"),Locale.define("fi","app",{}),Locale.inherit("fi","en"),Locale.define("fr","app",{messages:{agentjoin:"{name} a rejoint chat",agentleave:"{name} a quitté chat",transfer:"Chat transféré à {name}",rating:"La discussion a été évaluée"},dialogClose:{title:"Voudriez-vous terminer le chat?",yes:"Oui",no:"Non",send:"Oui, et envoyer chat par email"},dialogSend:{title:"Envoyer chat par email",email:"Email",yes:"Envoyer",no:"Annuler"},dialogRating:{title:"Évaluer chat",cancel:"Ne pas évaluer",submit:"Envoyer",commentTitle:"Votre commentaire"},online:{title:"Aide",infoTitle:"Chat en direct",infoDesc:"Posez nous une question",maximize:"Maximiser",minimize:"Minimiser",hideTitle:"Cacher chat",closeTitle:"Fermer chat",settingsTitle:"Configuration",
disableSounds:"Désactiver les sons",enableSounds:"Activer les sons",visitor:"Moi",send:"Envoyer",textareaPlaceholder:"Écrivez ici, appuyez <enter> pour envoyer",typingMsg:"{name} écrit...",transcriptSendingTitle:"Email envoyé...",transcriptSendingDesc:"",transcriptSendedTitle:"Email envoyé avec succès",transcriptSendedDesc:"",rate:"Noter votre agent"},offline:{title:"Envoyez nous un message",notice:"Nous sommes actuellement indisponible, mais vous pouvez nous laisser un message. Nous vous répondrons dès que possible.",hideTitle:"Cacher chat",required:"",name:"Nom",email:"Email",message:"Votre message",submit:"Envoyer message",messageRequiredAlert:"Vous n'avez pas écrit de message",emailRequiredAlert:"Vous n'avez pas entré votre adresse email",emailInvalidAlert:"Email invalide",sendInfo:"Email en cours d'envoi...",successTitle:"Merci pour votre message",successDesc:"Votre message a été envoyé. Nous vous contacterons bientôt.",failureTitle:"Erreur",failureDesc:"Envoi a échoué",number:"Numéro de téléphone"
},widget:{online:"En ligne",away:"Absent",offline:"Hors ligne"},banner:{bubble:{text:"Nous sommes prêts à répondre"},arrow:{title:"Avez-vous",desc:"des questions?"}},button:{title:"Assistance"},login:{title:"Chat login",messageLabel:"Votre question",submit:"Démarrer un chat"}}),Locale.inherit("fr","en"),Locale.define("hi","app",{messages:{agentjoin:"<strong>{name}</strong> चैट करने के लिए जुडे.",agentleave:"<strong>{name}</strong> कट गया.",transfer:"चैट स्थानांतरित किया गया <b>{name}</b>"},dialogClose:{title:"आप बातचीत समाप्त करना चाहते हैं?",yes:"हाँ",no:"नही",send:"बातचीत ईमेल में भेजे"},dialogSend:{title:"बातचीत ईमेल में भेजे",email:"ईमेल एड्रेस",yes:"भेजें",no:"रद्द करें"},dialogRating:{title:"एजेंट की बातचीत को मूल्यनकित करें",submit:"भेजें",commentTitle:"अपनी टिप्पणी"},online:{title:"सहायता",infoTitle:"सिधि बातचीत",infoDesc:"हमसे  प्रश्न करें",maximize:"अधिकतम",minimize:"न्यूनतम",hideTitle:"चैट बंद करें",closeTitle:"बातचीत रद करें",settingsTitle:"सेटिंग",disableSounds:"आवाज़ बंद करें",
enableSounds:"आवाज़ चालु करें",visitor:"मैं",send:"भेजें",textareaPlaceholder:"यहाँ लिखें, भेजने के लिए <enter> दबाए",typingMsg:"<span>{name}</span> लिख रहे हे...",transcriptSendingTitle:"ईमेल बैज दिया...",transcriptSendingDesc:"",transcriptSendedTitle:"ईमेल बजने में सफल",transcriptSendedDesc:""},login:{title:"चैट लोगिन",messageLabel:"आपका प्रश्न",submit:"बातचीत प्रारंभ करें"},offline:{title:"हमें संदेश भेजें",notice:"हम इस समय उपलब्ध नहीं हैं, लेकिन आप हमें एक संदेश छोड़ सकते हैं। हम जितनी जल्दी हो सके जवाब देंगे",hideTitle:"चैट छुपाएं",required:"",name:"नाम",email:"ईमेल",message:"आपका संदेश",submit:"संदेश भेजें",messageRequiredAlert:"आप ने संदेश दर्ज नहीं किया",emailRequiredAlert:"आप ने ईमेल दर्ज नहीं किया",emailInvalidAlert:"अमान्य ईमेल",sendInfo:"ईमेल भेजा जा रहा है ...",successTitle:"आपके संदेश के लिए शुक्रिया!",successDesc:"आपका संदेश सफलतापूर्वक भेजा गया था। हम शीघ्र ही आपसे संपर्क करेंगे",failureTitle:"भेजने में त्रुटि",failureDesc:"हम क्षमा चाहते हैं, लेकिन आपके संदेश को भेजने में विफल रहे"
},widget:{online:"हमें कुछ पूछो",away:"हमें कुछ पूछो",offline:"हमें एक संदेश छोड़ दो"},banner:{bubble:{text:"हम आपके प्रश्नों के लिए तैयार कर रहे हैं!"},arrow:{title:"कोई सवाल?",desc:"हम जवाब देने के लिए तैयार हैं"}},button:{title:"समर्थन"}}),Locale.inherit("hi","en"),Locale.define("hr","app",{messages:{agentjoin:"{name} se pridružio razgovoru",agentleave:"{name} je napustio razgovor",transfer:"Razgovor proslijeđen na {name}"},dialogClose:{title:"Želite li završiti razgovor?",yes:"Da",no:"Ne",send:"Da, i pošalji razgovor na email"},dialogSend:{title:"Pošalji razgovor na email",email:"Email",yes:"Pošalji",no:"Otkaži"},dialogRating:{title:"Kako biste ocjenili razgovor?",cancel:"Ne želim ocjenjivati razgovor",submit:"Pošalji",commentTitle:"Vaš komentar"},online:{title:"Podrška",infoTitle:"Razgovor uživo",infoDesc:"Pitajte nas bilo što",maximize:"Raširi",minimize:"Sažmi",hideTitle:"Sakrij razgovor",closeTitle:"Zatvori razgovor",settingsTitle:"Postavke",disableSounds:"Onemogući zvukove",enableSounds:"Omogući zvukove",
visitor:"Ja",send:"Pošalji",textareaPlaceholder:"Pišite ovdje, pritisnite <enter> za slanje",typingMsg:"<span>{name}</span> tipka...",transcriptSendingTitle:"Šaljem email",transcriptSendedTitle:"Email je uspješno poslan"},login:{title:"Prijava za razgovor",messageLabel:"Vaše pitanje",submit:"Započni razgovor"},offline:{title:"Pošaljite nam poruku",notice:"Trenutno nismo dostupni, ali nam možete ostaviti poruku. Javit ćemo vam se u najkraćem mogućem roku.",hideTitle:"Sakrij razgovor",name:"Ime",email:"Email",message:"Vaša poruka",submit:"Pošalji poruku",messageRequiredAlert:"Niste upisali poruku.",emailRequiredAlert:"Niste unijeli email.",emailInvalidAlert:"Neispravan email",sendInfo:"Šaljem poruku...",successTitle:"Hvala na vašoj poruci",successDesc:"Vaša poruka je poslana. Kontaktirati ćemo vas uskoro.",failureTitle:"Greška",failureDesc:"Vaša poruka nije poslana",number:"Telefon"},widget:{online:"Online",away:"Odsutan",offline:"Offline"},banner:{bubble:{text:"Spremni smo za vaša pitanja"
},arrow:{title:"Imate pitanja?",desc:"Spremni smo odgovoriti na pitanja"}},button:{title:"Razgovor uživo"}}),Locale.inherit("hr","en"),Locale.define("hu","app",{messages:{agentjoin:"{name} csatlakozott a chathez",agentleave:"{name} elhagyta a chatet",transfer:"Chat átküldésre került {name}",rating:"Chat értékelve"},dialogClose:{title:"Szeretnél véget vetni a chat-nek?",yes:"Igen",no:"Nem",send:"Igen, és chat küldése emailben"},dialogSend:{title:"Chat küldése emailben",email:"E-mail",yes:"Küldés",no:"Mégse"},dialogRate:{title:""},online:{title:"Segítség",infoTitle:"Live chat",infoDesc:"Kérdezzen tőlünk bármit",maximize:"Nagyítás",minimize:"Kicsinyítés",hideTitle:"Chat elrejtése",closeTitle:"Chat bezárása",settingsTitle:"Beállítások",disableSounds:"Hang kikapcsolása",enableSounds:"Hang bekapcsolása",visitor:"Én",send:"Küldés",textareaPlaceholder:"Írja ide üzenetét, majd nyomja meg a küldéshez az <enter> gombot",typingMsg:"{name} éppen gépel...",transcriptSendingTitle:"E-mail elküldve...",
transcriptSendingDesc:"",transcriptSendedTitle:"E-mail sikeresen elküldve.",transcriptSendedDesc:"",rate:"Értékeld az agented"},offline:{title:"Küldjön nekünk üzenetet!",notice:"Most épp nem vagyunk elérhetők, de hagyhat nekünk üzenetet, melyet amint lehet, megválaszolunk.",hideTitle:"Chat elrejtése",name:"Név",email:"E-mail",message:"Az üzenete",submit:"Üzenet elküldése",messageRequiredAlert:"Nem írt be üzenetet",emailRequiredAlert:"Nem adott meg e-mail címet",emailInvalidAlert:"Érvénytelen e-mail cím",sendInfo:"E-mail küldése folyamatban van...",successTitle:"Köszönjük üzenetét",successDesc:"Az üzenet küldése sikeres volt. Hamarosan felvesszük Önnel a kapcsolatot.",failureTitle:"Hiba",failureDesc:"Az üzenet küldése sajnos sikertelen volt",number:"Telefonszám"},widget:{online:"Online",away:"Hiányzó",offline:"Offline"},banner:{bubble:{text:"Készen állunk a kérdéseire"},arrow:{title:"Van kérdése?",desc:"Kapj válaszokat most"}},button:{title:"Live chat"},dialogRating:{title:"Hogyan értékelnéd a chat-et?",
cancel:"Nem akarom értékelni",submit:"Küldés",commentTitle:"A hozzászólásod"},login:{title:"Chat login",messageLabel:"A kérdésed",submit:"Chat indítása"}}),Locale.inherit("hu","en"),Locale.define("it","app",{messages:{agentjoin:"{name} unito a chat",agentleave:"{name} lasciato chat",transfer:"Chat è stata trasferita a {name}",rating:"La chat è stata valutata"},dialogClose:{title:"Vorresti terminare chat?",yes:"Si",no:"No",send:"Si, e invia chat per email"},dialogSend:{title:"Invia chat per email",email:"Email",yes:"Invia",no:"Cancella"},dialogRating:{title:"Vota chat con un' agente",cancel:"Non votare",submit:"Invia",commentTitle:"Tuo commento"},online:{title:"Supporto",infoTitle:"Live chat",infoDesc:"Chiedici qualsiasi cosa",maximize:"Massimizza",minimize:"Minimizza",hideTitle:"Nascondi chat",closeTitle:"Chiudi chat",settingsTitle:"Opzioni",disableSounds:"Disabilita i souni",enableSounds:"Abilita i suoni",visitor:"Io",send:"Invia",textareaPlaceholder:"Scrivi qua, premi <invio> per inviare",
typingMsg:"{name} sta scrivendo...",transcriptSendingTitle:"Email è stata inviata...",transcriptSendingDesc:"",transcriptSendedTitle:"Email è stata inviata correttamente",transcriptSendedDesc:"",rate:"Valuta il tuo agente"},login:{title:"Chat login",messageLabel:"Tue domande",submit:"Inizia chat"},offline:{title:"Inviaci un messaggio",notice:"Lasciaci un messaggio. Ti risponderemo al più presto possibile.",hideTitle:"Nascondi chat",required:"",name:"Nome",email:"Email",message:"Tuo messaggio",submit:"Invia messaggio",messageRequiredAlert:"Non hai inserito un messaggio",emailRequiredAlert:"Non hai inseriti un' indirizzo email",emailInvalidAlert:"Indirizzo email non valido",sendInfo:"Email sta partendo...",successTitle:"Grazie per tuo messaggio",successDesc:"Tuo messaggio è stato inviato correttamente. Ti contatteremo presto.",failureTitle:"Errore",failureDesc:"Tuo messaggio non è stato inviato",number:"Numero di telefono"},widget:{online:"Online",away:"Fuori",offline:"Offline"},banner:{bubble:{
text:"Siamo pronti per tue domande"},arrow:{title:"Qualche domanda?",desc:"Pronti a rispondere"}},button:{title:"Supporto"}}),Locale.inherit("it","en"),Locale.define("ka","app",{messages:{agentjoin:"{name} შემოუერთდა ჩეთს",agentleave:"{name} დატოვა ჩეთი",transfer:"ჩეთი გადაირთო ოპერატორთან  {name}"},dialogClose:{title:"გნებავთ ჩეთის დასრულება?",yes:"დიახ",no:"არა",send:"დიახ, და გამომიგზავნეთ ჩეთი ელ-ფოსტაზე"},dialogSend:{title:"გამომიგზავნეთ ჩეთი ელ-ფოსტაზე",email:"ელ-ფოსტა",yes:"გაგზავნა",no:"გაუქმება"},dialogRating:{title:"როგორ შეაფასებთ საუბარს?",cancel:"არ მსურს შეფასება",submit:"გაგზავნა",commentTitle:"თქვენი კომენტარი"},online:{title:"დახმარება",infoTitle:"ონლაინშია",infoDesc:"გვკითხეთ",maximize:"გადიდება",minimize:"დაპატარავება",hideTitle:"ჩახურვა",closeTitle:"დახურვა",settingsTitle:"პარამეტრები",disableSounds:"ხმის გათიშვა",enableSounds:"ხმის ჩართვა",visitor:"მე",send:"გაგზავნა",textareaPlaceholder:"დაწერეთ აქ, დააჭირეთ <Enter>-ს გასაგზავნად",typingMsg:"{name} წერს",transcriptSendingTitle:"ვაგზავნით ელ-ფოსტაზე",
transcriptSendedTitle:"მესიჯი წარმატებით გაიგზავნა"},login:{title:"ჩეთში შესვლა",messageLabel:"თქვენი შეკითხვა",submit:"ჩეთის დაწყება"},offline:{title:"მოგვწერეთ",notice:"ამ მომენტში ხაზზე არ ვართ, მაგრამ თქვენ შეგიძლიათ დაგვიტოვოთ შეტყობინება და ჩვენ მალე გიპასუხებთ.",hideTitle:"ჩეთის დამალვა",name:"სახელი",email:"ელ-ფოსტა",message:"თქვენი მესიჯი",submit:"მესიჯის გაგზავნა",messageRequiredAlert:"თქვენ არ შეგიყვანიათ მესიჯი",emailRequiredAlert:"თქვენ  არ შეგიყვანიათ ელ-ფოსტა",emailInvalidAlert:"არასწწორი ელ-ფოსტა",sendInfo:"ვაგზავნით მესიჯს",successTitle:"მადლობა თქვენი მესიჯისთვის",successDesc:"თქვენი მესიჯი წარმატებით გაიგზავნა. ჩვენ მალე დაგიკავშირდებით.",failureTitle:"შეცდომა",failureDesc:"თქვენი მეიჯი ვერ გაიგზავნა",number:"ტელეფონის ნომერი"},widget:{online:"ხაზზეა",away:"დაკავებულია",offline:"გასულია"},banner:{bubble:{text:"მზად ვართ თქვენი კითხვის მისაღებად"},arrow:{title:"კითხვა გაქვთ?",desc:"მზად ვართ გიპასუხოთ"}},button:{title:"ონლაინ ჩეთი"}}),Locale.inherit("ka","en"),Locale.define("lt","app",{
messages:{agentjoin:"{name} prisijungė prie chat",agentleave:"{name} atsijungė nuo chat",transfer:"Chat perduotas {name}"},dialogClose:{title:"Ar norite baigti chat?",yes:"Taip",no:"Ne",send:"Taip, ir tęskite chat el. paštu"},dialogSend:{title:"Išsiųsti chat į el. paštą",email:"El. paštas",yes:"Siųsti",no:"Baigti"},dialogRating:{title:"Kaip įvertintumėte pokalbį?",cancel:"Nenoriu vertinti",submit:"Siųsti",commentTitle:"Jūsų komentaras"},online:{title:"Pagalba",infoTitle:"Live chat",infoDesc:"Klauskite mūsų",maximize:"Išskleisti",minimize:"Suskleisti",hideTitle:"Paslėpti pokalbį",closeTitle:"Baigti pokalbį",settingsTitle:"Nustatymai",disableSounds:"Išjungti garsą",enableSounds:"Įjungti garsą",visitor:"Aš",send:"Siųsti",textareaPlaceholder:"Rašykite čia, spauskite <enter> išsiųsti",typingMsg:"{name} rašo ...",transcriptSendingTitle:"Siunčiamas el. laiškas",transcriptSendingDesc:"El. laiškas sėkmingai išsiųstas",transcriptSendedTitle:"Prisijungti prie pokalbio"},login:{title:"Prisijungti prie chat",
messageLabel:"Klauskite",submit:"Pradėti chat"},offline:{title:"Atsiųskite mums žinutę",notice:"Šiuo metu negalime atsakyti, palikite mums žinutę, atsakysime kaip galima greičiau.",hideTitle:"Paslėpti chat",name:"Vardas",email:"El. paštas",message:"Jūsų žinutė",submit:"Siųsti",messageRequiredAlert:"Neįrašėte žinutės",emailRequiredAlert:"Neįrašėte el. pašto adreso",emailInvalidAlert:"Neteisingas el. pašto adresas",sendInfo:"Siunčiamas el. laiškas",successTitle:"Ačiū už Jūsų žinutę",successDesc:"Jūsų žinutė sėkmingai išsiųsta. Susisieksime su Jumis artimiausiu metu.",failureTitle:"Klaida",failureDesc:"Jūsų žinutė neišsiųsta",number:"Telefono"},widget:{online:"Online\n",away:"Atsitraukęs",offline:"Offline"},banner:{bubble:{text:"Laukiame Jūsų klausimų"},arrow:{title:"Ar turite klausimų?",desc:"Esame pasiruošę atsakyti"}},button:{title:"Live chat"}}),Locale.inherit("lt","en"),Locale.define("nl","app",{messages:{agentjoin:"{name} toegetreden tot chat",agentleave:"{name} heeft chat verlaten",
transfer:"Chat overgezet naar {name}",rating:"Chat is beoordeeld"},dialogClose:{title:"Wilt u het gesprek graag beëindigen?",yes:"Ja",no:"Nee",send:"Ja, stuur de chat naar email"},dialogSend:{title:"Stuur het gesprek naar email",email:"Email",yes:"Stuur",no:"Annuleer"},dialogRating:{title:"Beoordeel deze service",submit:"Verstuur",commentTitle:"Opmerking"},online:{title:"Hulp",infoTitle:"Live chat",infoDesc:"Stel ons uw vragen",maximize:"Maximaliseer",minimize:"Minimaliseer",hideTitle:"Verberg chat",closeTitle:"Sluit chat",settingsTitle:"Instellingen",disableSounds:"Zet geluid uit",enableSounds:"Zet geluid aan",visitor:"Ik",send:"Stuur",textareaPlaceholder:"Type hier, druk op <enter> om te versturen",typingMsg:"<span>{name}</span> is aan het typen...",transcriptSendingTitle:"Email is verzonden...",transcriptSendingDesc:"",transcriptSendedTitle:"Email is succesvol verzonden",transcriptSendedDesc:"",rate:"Beoordeel je agent"},login:{title:"Chat login",messageLabel:"Uw vraag",submit:"Begin chat"
},offline:{title:"Stuur ons een bericht",notice:"We zijn momenteel niet bereikbaar, maar u kunt een bericht bij ons achterlaten. Wij zullen zo spoedig mogelijk reageren.",hideTitle:"Verberg chat",name:"Naam",email:"Email",message:"Uw bericht",submit:"Stuur bericht",messageRequiredAlert:"U heeft geen bericht ingevuld",emailRequiredAlert:"U heeft geen email adres ingevuld",emailInvalidAlert:"Onjuist email adres",sendInfo:"Email is aan het versturen...",successTitle:"Bedankt voor uw bericht",successDesc:"Uw bericht is succesvol verstuurd. We nemen contact met u op.",failureTitle:"Fout",failureDesc:"Het versturen van uw bericht is helaas mislukt",number:"Telefoonnummer"},widget:{online:"Online",away:"Afwezig",offline:"Offline"},banner:{bubble:{text:"We zitten klaar voor uw vragen"},arrow:{title:"Heeft u vragen?",desc:"Wij antwoorden direct"}},button:{title:"Hulp"}}),Locale.inherit("nl","en"),Locale.define("no","app",{messages:{agentjoin:"<strong>{name}</strong> logget på.",agentleave:"<strong>{name}</strong> logget av.",
transfer:"Samtalen er overført til <strong>{name}</strong>"},dialogClose:{title:"Vil du avslutte chatten?",yes:"Ja",no:"Nei",send:"Ja, og send korrespondansen til min e-post"},dialogSend:{title:"Send korrespondansen til min e-post",email:"E-post",yes:"Send",no:"Avbryt"},dialogRating:{title:"Vurdér samtalen ",cancel:"Avbryt"},online:{title:"Support",infoTitle:"Live chat",infoDesc:"Spør oss om alt",maximize:"Maksimer",minimize:"Minimer",hideTitle:"Skjul chat",closeTitle:"Lukk chat",settingsTitle:"Instillinger",disableSounds:"Slå av lyd",enableSounds:"Slå på lyd ",visitor:"Meg",send:"Send",textareaPlaceholder:"Skriv her, trykk <enter> for å sende",typingMsg:"<span>{name}</span> skriver...",transcriptSendingTitle:"E-post sendt...",transcriptSendingDesc:"",transcriptSendedTitle:"E-mailen ble sendt",transcriptSendedDesc:""},login:{title:"Chat login",messageLabel:"Ditt spørsmål",submit:"Start chat"},offline:{title:"Send oss en melding",notice:"Vi er desverre ikke online for øyeblikket, men legg igjen en melding til oss og vi kommer tilbake så raskt vi kan.",
hideTitle:"Skjul chat",required:"påkrevet",name:"Navn",email:"E-post",message:"Din melding",submit:"Send melding",messageRequiredAlert:"Du har ikke skrevet en melding.",emailRequiredAlert:"Du har ikke skrevet en e-post.",emailInvalidAlert:"Ugyldig e-post",sendInfo:"E-post blir sendt...",successTitle:"Takk for din melding!",successDesc:"Din e-post ble sendt. Vi kontakter deg så raskt vi kan",failureTitle:"Feil ved sending.",failureDesc:"Vi beklager! Der oppstod en feil ved sending av meldingen."},widget:{online:"Spør oss om alt",away:"Spør oss om alt",offline:"Legg inn en melding",counterMsg:"Du har {count} uleste meldinger"},banner:{bubble:{text:"Vi er klar til å mot dine spørsmål!"},arrow:{title:"Noen spørsmål?",desc:"Vi er klar til å svare."}},button:{title:"hjelp"}}),Locale.inherit("no","en"),Locale.define("pl","app",{messages:{agentjoin:"{name} podłączony do chatu",agentleave:"{name} opuścił chat",transfer:"Chat przekazany na {name}",rating:"Rozmowa została oceniona"},dialogClose:{title:"Zakończyć chat?",
yes:"Tak",no:"Nie",send:"Tak, wyślij chat na email"},dialogSend:{title:"Wyślij chat na email",email:"Email",yes:"Wyślij",no:"Anuluj"},dialogRating:{title:"Oceń chat",cancel:"Nie chcę ocenić",submit:"Wyślij",commentTitle:"Twój komentarz"},online:{title:"Wsparcie",infoTitle:"Live chat",infoDesc:"Zapytaj o wszystko",maximize:"Powiększ",minimize:"Zmniejsz",hideTitle:"Ukryj chat",closeTitle:"Zakończyć chat",settingsTitle:"Ustawienia",disableSounds:"Wyłącz dzwięk",enableSounds:"Włącz dzwięk",visitor:"Ja",send:"Wyślij",textareaPlaceholder:"Napisz tutaj, naciśnij klawisz <enter>, aby wysłać",typingMsg:"{name} pisze...",transcriptSendingTitle:"Email wysyłanie...",transcriptSendingDesc:"",transcriptSendedTitle:"Email wysłany",transcriptSendedDesc:"",rate:"Oceń swojego agenta"},offline:{title:"Wyslij nam wiadomość",notice:"W tym momencie nie jesteśmy dostępni, ale możesz zostawić wiadomość. Postaramy się odpowiedzieć tak szybko jak to możliwe.",hideTitle:"Ukryj chat",name:"Imię",email:"Email",message:"Twoja wiadomość",
submit:"Wyślij wiadomość",messageRequiredAlert:"Brak wiadomości",emailRequiredAlert:"Brak adresu email",emailInvalidAlert:"Nieprawidłowy adres email",sendInfo:"Email wysyłanie...",successTitle:"Dziękuję za wiadomość",successDesc:"Twoja wiadomość została wysłana z powodzeniem. Skontaktujemy się.",failureTitle:"Błąd",failureDesc:"Nie powiodło się wysyłanie",number:"Numer telefonu"},widget:{online:"Online",away:"Zaraz wracam",offline:"Offline"},banner:{bubble:{text:"Jesteśmy gotowi na pytania"},arrow:{title:"Zapytaj o wszystko",desc:"Pomożemy Ci"}},button:{title:"Live chat"},login:{title:"Chat login",messageLabel:"Twoje pytanie",submit:"Zacząć chat"}}),Locale.inherit("pl","en"),Locale.define("pt","app",{messages:{agentjoin:"{name} entrou no chat",agentleave:"{name} saiu do chat",transfer:"O chat foi transferido para {name}",rating:"Chat foi avaliado"},dialogClose:{title:"Gostaria de finalizar o chat?",yes:"Sim",no:"Não",send:"Sim, e envie o chat por email"},dialogSend:{title:"Enviar chat por email",
email:"Email",yes:"Enviar",no:"Cancelar"},online:{title:"Suporte",infoTitle:"Chat",infoDesc:"Pergunte-nos qualquer coisa",maximize:"Maximizar",minimize:"Minimizar",hideTitle:"Esconder chat",closeTitle:"Fechar chat",settingsTitle:"Configurações",disableSounds:"Desativar sons",enableSounds:"Ativar sons",visitor:"Eu",send:"Enviar",textareaPlaceholder:"Escreva aqui, pressione <enter> para enviar",typingMsg:"{name} está digitando...",transcriptSendingTitle:"Enviando email...",transcriptSendingDesc:"",transcriptSendedTitle:"Email enviado",transcriptSendedDesc:"",rate:"Avaliar o agente"},offline:{title:"Envie-nos uma mensagem",notice:"Não estamos disponíveis no momento, mas você pode deixar uma mensagem. Responderemos o mais rápido possível.",hideTitle:"Esconder chat",name:"Nome",email:"Email",message:"Sua mensagem",submit:"Enviar mensagem",messageRequiredAlert:"Você não digitou uma mensagem",emailRequiredAlert:"Você não digitou um email",emailInvalidAlert:"Email invalido",sendInfo:"Enviando email...",
successTitle:"Agradecemos pela mensagem",successDesc:"Sua mensagem foi enviada com sucesso. Entraremos em contato em breve.",failureTitle:"Erro",failureDesc:"Sua mensagem não foi enviada",number:"Telefone"},widget:{online:"Online",away:"Ausente",offline:"Offline"},banner:{bubble:{text:"Estamos prontos para responder suas questões"},arrow:{title:"Questões?",desc:"Estamos aqui p/ responder"}},button:{title:"Chat"},dialogRating:{title:"Como você avalia o chat?",cancel:"Não quero avaliar",submit:"Enviar",commentTitle:"Seu comentário"},login:{title:"Entrar no chat",messageLabel:"Sua pergunta",submit:"Iniciar chat"},events:{visitorSendMessageAction:"Visitante enviou uma mensagem",visitorSendMessageLabel:"visitante enviou uma mensagem",operatorSendMessageAction:"Agente enviou uma mensagem",operatorSendMessageLabel:"{name} enviou uma mensagem",triggerSendMessageAction:"Ativador enviado",triggerSendMessageLabel:"ativador {trigger} escreveu",visitorReplyTriggerAction:"Visitante respondeu a um ativador",
visitorReplyTriggerLabel:"visitante respondeu a um ativador {trigger}",conversationByOperatorAction:"Conversa",conversationByOperatorLabel:"{name} iniciou um chat ",conversationByVisitorAction:"Conversa",conversationByVisitorLabel:"visitante iniciou um chat com {name}",conversationByTriggerAction:"Conversa",conversationByTriggerLabel:" ",closeChatAction:"Fechar chat",closeChatLabel:"{type}"}}),Locale.inherit("pt","en"),Locale.define("ro","app",{messages:{agentjoin:"<strong>{name}</strong> conectat la chat.",agentleave:"<strong>{name}</strong> deconectat.",transfer:"Chatul a fost transferat la <b>{name}</b>"},dialogClose:{title:"Doriți să terminați conversația?",yes:"Da",no:"Nu",send:"Da, trimite conversația prin e-mail"},dialogSend:{title:"Trimite conversația prin e-mail",email:"Adresa de e-mail",yes:"Trimite",no:"Anulare"},dialogRating:{title:"V-a fost de folos conversația?",submit:"Trimite",commentTitle:"Adaugă commentariu"},online:{title:"Suport",infoTitle:"Chat live",infoDesc:"Adresați-ne orice întrebări",
maximize:"Maximalizați",minimize:"Minimalizați",hideTitle:"Ascunde chatul",closeTitle:"Închide Chatul",settingsTitle:"Setări",disableSounds:"Dezactivare sunete",enableSounds:"Activare sunete",visitor:"Eu",send:"Trimite",textareaPlaceholder:"Scrieți aici și apăsați <enter> pentru a trimite",typingMsg:"<span>{name}</span> tastează..",transcriptSendingTitle:"E-mail trimis...",transcriptSendingDesc:"",transcriptSendedTitle:"E-mailul a fost trimis cu succes",transcriptSendedDesc:""},login:{title:"Autentificare în chat",messageLabel:"Întrebarea dvs.",submit:"Porniți chatul"},offline:{title:"Trimiteţi-ne un mesaj",notice:"Momentan nu este disponibil nici un operator. Vă rugăm să ne lăsați un mesaj și vom răspunde în cel mai scurt timp posibil.",hideTitle:"Ascunde chatul",required:"",name:"Nume",email:"Email",message:"Mesajul tău",submit:"Trimite mesajul",messageRequiredAlert:"Nu ați scris nici un mesaj.",emailRequiredAlert:"Nu ați introdus nici o adresă de e-mail.",emailInvalidAlert:"Adresă de e-mail invalidă",
sendInfo:"Se trimite e-mailul...",successTitle:"Mulțumim pentru mesajul tău!",successDesc:"Mesajul tău a fost trimis cu succes. Veți fi contactat în curând.",failureTitle:"Eroare.",failureDesc:"Ne cerem scuze, dar mesajul tău nu a fost trimis."},widget:{away:"Absent"},banner:{bubble:{text:"Așteptăm întrebările dvs.!"},arrow:{title:"Aveți întrebări?",desc:"Vă stăm la dispoziție!"}},button:{title:"suport"}}),Locale.inherit("ro","en"),Locale.define("ru","app",{messages:{agentjoin:"<strong>{name}</strong> подключился к диалогу.",agentleave:"<strong>{name}</strong> вышел из диалога.",transfer:"Переключение диалога на консультанта <b>{name}</b>"},dialogClose:{title:"Вы хотите закончить чат?",yes:"Да",no:"Нет",send:"Да, переслать диалог на мой e-mail"},dialogSend:{title:"Переслать диалог на мой e-mail",email:"E-mail",yes:"Отправить",no:"Отменить"},dialogRating:{title:"Пожалуйста, оцените работу консультанта",cancel:"Не хочу ставить оценку"},online:{title:"Поддержка",infoTitle:"Онлайн консультант",
infoDesc:"Задайте любые вопросы",maximize:"Увеличить окно",minimize:"Уменьшить oкнo",hideTitle:"Скрыть чат",closeTitle:"Закрыть чат",settingsTitle:"Настройка",disableSounds:"Отключить звук",enableSounds:"Включить звук",visitor:"Вы",send:"Отправить",textareaPlaceholder:"Введите Ваше сообщение, для отправления нажмите <Enter>",typingMsg:"<span>{name}</span> пишет...",transcriptSendingTitle:"E-mail отправляется...",transcriptSendingDesc:"",transcriptSendedTitle:"E-mail был отправлен",transcriptSendedDesc:""},offline:{title:"Напишите нам сообщение",notice:"К сожалению, в данный момент нас нет на месте. Оставьте, пожалуйста, сообщение, и мы с вами обязательно свяжемся.",hideTitle:"Скрыть чат",name:"Имя",email:"Email",message:"Напишите нам сообщение",submit:"Отправить",messageRequiredAlert:"Вы не написали сообщение.",emailRequiredAlert:"Вы не написали e-mail.",emailInvalidAlert:"Недействительный e-mail.",sendInfo:"Email отправляется...",successTitle:"Спасибо за Ваш вопрос!",successDesc:"Ваш вопрос был отправлен. В ближайшее время мы с Вами обязательно свяжемся.",
failureTitle:"Ошибка при отправлении",failureDesc:"К сожалению, Ваш вопрос не удалось отправить."},widget:{online:"oнлайн",away:"отсутствует",offline:"oффлайн"},banner:{bubble:{text:"Напишите нам, мы готовы ответить на Ваши вопросы!"},arrow:{title:"У вас есть вопросы?",desc:"Мы готовы ответить"}},button:{title:"поддержка"}}),Locale.inherit("ru","en"),Locale.define("sk","app",{messages:{agentjoin:"{name} sa pripojil(a) do chatu",agentleave:"{name} sa odpojil(a) z chatu",transfer:"Chat bol presmerovaný na {name}",rating:"Chat bol ohodnotený"},dialogClose:{title:"Prajete si ukončiť chat?",yes:"Ano",no:"Nie",send:"Ano, a chat zaslať na email"},dialogSend:{title:"Odoslať chat na email",email:"Email",yes:"Odoslať",no:"Zrušiť"},dialogRating:{title:"Ohodnoťte prácu operátora",cancel:"Nechcem hodnotiť",submit:"Odoslať",commentTitle:"Váš komentár"},online:{title:"Podpora",infoTitle:"Live chat",infoDesc:"Opýtajte sa nás čokoľvek",maximize:"Zväčšiť okno",minimize:"Zmenšiť okno",hideTitle:"Schovať chat",
closeTitle:"Ukončiť chat",settingsTitle:"Nastavenia",disableSounds:"Vypnúť zvuky",enableSounds:"Zapnúť zvuky",visitor:"Ja",send:"Odoslať",textareaPlaceholder:"Píšte sem, pre odoslanie stlačte <enter>",typingMsg:"{name} píše...",transcriptSendingTitle:"Email sa odosiela...",transcriptSendingDesc:"",transcriptSendedTitle:"Email bol úspešne odoslaný",transcriptSendedDesc:"",rate:"Ohodnoťte operátora"},login:{title:"Zahájenie chatu",messageLabel:"Vaša otázka",submit:"Začať chat"},offline:{title:"Napíšte nám správu",notice:"Momentálne nie sme k dispozícii, ale môžete nám zanechat zprávu.",hideTitle:"Schovať chat",name:"Meno",email:"Email",message:"Napíšte nám správu",submit:"Odoslať správu",messageRequiredAlert:"Nezadali ste žiadnu správu",emailRequiredAlert:"Nezadali ste email",emailInvalidAlert:"Neplatný email",sendInfo:"Email sa odosiela...",successTitle:"Ďakujeme za Váš dotaz",successDesc:"Váš dotaz bol úspešne odoslaný. V blízkej dobe Vás budeme kontaktovať.",failureTitle:"Chyba pri odosielaní",
failureDesc:"Váš dotaz se nepodarilo odoslať",number:"Telefón"},widget:{online:"Online",away:"Preč",offline:"Offline"},banner:{bubble:{text:"Máte otázky?"},arrow:{title:"Máte otázky?",desc:"Radi vám poradíme"}},button:{title:"Podpora"}}),Locale.inherit("sk","en"),Locale.define("sl","app",{messages:{agentjoin:"{name} se je pridružil/a pogovoru",agentleave:"{name} je zapustil/a pogovor",transfer:"Pogovor prenesen na {name}"},dialogClose:{title:"Bi želeli zaključiti pogovor?",yes:"Da",no:"No",send:"Da, pošljite mi pogovor na email"},dialogSend:{title:"Pošljite mi pogovor na email",email:"Email",yes:"Pošlji",no:"Prekliči"},dialogRating:{title:"Kako bi ocenili pogovor?",cancel:"Ne želim oceniti",submit:"Pošlji",commentTitle:"Vaš komentar"},online:{title:"Podpora",infoTitle:"Live chat",infoDesc:"Vprašajte nas karkoli",maximize:"Povečaj",minimize:"Zmanjšaj",hideTitle:"Skrij pogovor",closeTitle:"Zapri pogovor",settingsTitle:"Nastavitve",disableSounds:"Onemogoči zvok",enableSounds:"Omogoči zvok",
visitor:"Jaz",send:"Pošlji",textareaPlaceholder:"Pišite tukaj in pritisnite <enter> za pošiljanje",typingMsg:"{name} tipka...",transcriptSendingTitle:"Pošiljanje emaila...",transcriptSendedTitle:"Email je bil uspešno poslan"},login:{title:"Pogovor prijava",messageLabel:"Vaše vprašanje",submit:"Začni pogovor"},offline:{title:"Pošljite nam sporočilo",notice:"Trenutno nismo dosegljivi, vendar nam lahko pustite sporočilo. Kontaktirali vas bomo takoj ko bo mogoče.",hideTitle:"Skrij pogovor",name:"Ime",email:"Email",message:"Vaše sporočilo",submit:"Pošlji sporočilo",messageRequiredAlert:"Niste vnesli sporočila",emailRequiredAlert:"Niste vnesli emaila",emailInvalidAlert:"Napačen email",sendInfo:"Pošiljanje emaila...",successTitle:"Hvala za vaše sporočilo",successDesc:"Vaše sporočilo je bilo uspešno poslano. Kmalu vas bomo kontaktirali.",failureTitle:"Napaka",failureDesc:"Vaše sporočilo ni bilo poslano",number:"Telefon"},widget:{online:"Online",away:"Trenutno nedosegljivi",offline:"Offline"},banner:{
bubble:{text:"Pripravljeni smo na vaša vprašanja"},arrow:{title:"Imate vprašanje?",desc:"Na voljo za odgovor"}},button:{title:"Live chat"}}),Locale.inherit("sl","en"),Locale.define("sv","app",{messages:{agentjoin:"{name} anslöt sig till chatten",agentleave:"{name} lämnat chatten",transfer:"Chatten var överförd till {name}"},dialogClose:{title:"Vill du avsluta chatten?",yes:"Ja",no:"Nej",send:"Ja, och skicka chatten till mailen"},dialogSend:{title:"Skicka chatten till mailen",email:"E-post",yes:"Skicka",no:"Ångra"},dialogRating:{title:"Vilket betyg skulle du ge chatten?",cancel:"Jag vill inte betygsätta",submit:"Skicka",commentTitle:"Din kommentar"},online:{title:"Support",infoTitle:"Live chat",infoDesc:"Fråga oss om vad som helst",maximize:"Maximera",minimize:"Minimera",hideTitle:"Göm chat",closeTitle:"Stäng chat",settingsTitle:"Inställningar",disableSounds:"Avaktivera ljud",enableSounds:"Aktivera ljud",visitor:"Jag",send:"Skicka",textareaPlaceholder:"Skriv här, tryck <enter> för att skicka",
typingMsg:"{name} skriver...",transcriptSendingTitle:"Skickar mail...",transcriptSendedTitle:"Mailet skickades korrekt"},login:{title:"Chat inloggning",messageLabel:"Din fråga",submit:"Starta chat"},offline:{title:"Skicka oss ett meddelande",notice:"Vi finns inte tillgängliga just nu men du kan lämna ett meddelande till oss. Så kommer vi att kontakta dig så fort vi kan.",hideTitle:"Göm chat",name:"Namn",email:"E-post",message:"Ditt meddelande",submit:"Skicka meddelande",messageRequiredAlert:"Du har inte skrivit något meddelande",emailRequiredAlert:"Du har inte angett någon e-postadress",emailInvalidAlert:"Felaktig e-postadress",sendInfo:"Skickar e-post...",successTitle:"Tack för ditt meddelande",successDesc:"Ditt meddelande skickades korrekt. Vi kommer kontakta dig så fort vi kan.",failureTitle:"Fel",failureDesc:"Ditt meddelande skickades inte",number:"Telefonnummer"},widget:{online:"Inloggad",away:"Borta",offline:"Ej inloggad"},banner:{bubble:{text:"Vi är redo för dina frågor"},arrow:{
title:"Några frågor?",desc:"Vi är redo att svara"}},button:{title:"Live chat"}}),Locale.inherit("sv","en"),Locale.define("tr","app",{messages:{agentjoin:"{name} katıldı",agentleave:"{name} ayrıldı",transfer:"Diyalog {name} adlı operatöre aktarıldı"},dialogClose:{title:"Diyaloğu sonlandırmak mı istiyorsunuz?",yes:"Evet",no:"Hayır",send:"Evet ve diyaloğu emailime gönder"},dialogSend:{title:"Diyaloğu emailime gönder",email:"Email",yes:"Gönder",no:"İptal"},dialogRating:{title:"Bu diyalog için kaç verirsiniz?",cancel:"Değerlendirmek istemiyorum",submit:"Gönder",commentTitle:"Yorumunuz"},online:{title:"Destek",infoTitle:"Live chat",infoDesc:"Yardıma ihtiyacınız var mı?",maximize:"Büyüt",minimize:"Küçült",hideTitle:"Diyaloğu gizle",closeTitle:"Diyaloğu kapat",settingsTitle:"Ayarlar",disableSounds:"Sesli bildirimi devre dışı bırak",enableSounds:"Sesli bildirimi etkinleştir",visitor:"Ben",send:"Gönder",textareaPlaceholder:"Mesajınızı yazın ve göndermek için klavyeden <enter> tuşuna basın",typingMsg:"<span>{name}</span> yazıyor...",
transcriptSendingTitle:"Mail gönderiliyor...",transcriptSendedTitle:"Email gönderimi başarılı"},login:{title:"Diyalog girişi",messageLabel:"Sorunuz",submit:"Diyaloğu başlat"},offline:{title:"Mesaj bırakmak ister misiniz?",notice:"Şu anda mesai dışındayız ancak mesajınızı iletebilirsiniz. Mümkün olan en kısa süre içinde yanıtlanacağından emin olunuz.",hideTitle:"Diyaloğu gizle",name:"Adınız",email:"Email adresiniz",message:"Mesajınız",submit:"Gönder",messageRequiredAlert:"Mesajınızı yazmadınız.",emailRequiredAlert:"Email adresinizi girmediniz.",emailInvalidAlert:"Email adresinizde hata var",sendInfo:"Email gönderiliyor...",successTitle:"Mesajınız için teşekkürler",successDesc:"Mesajınız gönderildi. Yakında görüşmek dileğiyle.",failureTitle:"Hata",failureDesc:"Mesajınız gönderilemedi.",number:"İletişim numaranız"},widget:{online:"Çevrim-içi",away:"Moladayız",offline:"Çevrim-dışı"},banner:{bubble:{text:"Sorularınızı bekliyoruz"},arrow:{title:"Nasıl yardımcı olabiliriz?",desc:"Yanıtlamaya hazırız"
}},button:{title:"Live chat"}}),Locale.inherit("tr","en"),Locale.define("tw","app",{messages:{agentjoin:"{name} 加入對話",agentleave:"{name} 離開對話",transfer:"對話已移轉至 {name}"},dialogClose:{title:"您要結束對話？",yes:"是",no:"否",send:"是，請將對話傳送至Email信箱。"},dialogSend:{title:"對話傳送至Email信箱",email:"Email",yes:"發送",no:"取消"},dialogRating:{title:"本次對話，您給予多少評分？",cancel:"略過評分",submit:"發送",commentTitle:"您的問題"},online:{title:"線上客服",infoTitle:"線上對話",infoDesc:"歡迎提問",maximize:"增加",minimize:"減少",hideTitle:"隱藏對話視窗",closeTitle:"關閉對話視窗",settingsTitle:"設定",disableSounds:"關閉提醒鈴聲",enableSounds:"開啟提醒鈴聲",visitor:"我",send:"發送",textareaPlaceholder:"在此輸入您的訊息，輸入後請按<發送>鍵。",typingMsg:"<span>{name}</span> 正在輸入...",transcriptSendingTitle:"發送Email...",transcriptSendedTitle:"Email已送出"},login:{title:"登入對話",messageLabel:"您的問題",submit:"開始對話"},offline:{title:"請留下您的訊息",notice:"由於客服人員目前不在線上，請留下您的聯絡方式，我們將盡速與您聯繫！",hideTitle:"隱藏對話視窗",name:"姓名",email:"Email",message:"您的訊息",submit:"發送",messageRequiredAlert:"您尚未輸入任何訊息",emailRequiredAlert:"您尚未輸入您的Email",
emailInvalidAlert:"無效的Email信箱",sendInfo:"發送Email...",successTitle:"謝謝您的訊息",successDesc:"您的訊息已送出，我們將盡速與您聯繫！",failureTitle:"錯誤",failureDesc:"抱歉，您的訊息未送出！",number:"電話"},widget:{online:"線上",away:"離開",offline:"離線"},banner:{bubble:{text:"歡迎隨時提問"},arrow:{title:"您有什麼疑問？",desc:"我們隨時為您解答"}},button:{title:"線上對話"},events:{visitorSendMessageAction:"訪客已發送訊息",visitorSendMessageLabel:"訪客已發送訊息",operatorSendMessageAction:"客服人員已發送訊息",operatorSendMessageLabel:"{name} 已發送訊息",triggerSendMessageAction:"系統自動回覆已發送",triggerSendMessageLabel:"{trigger} 系統自動回覆",visitorReplyTriggerAction:"訪客對系統自動回覆留下訊息",visitorReplyTriggerLabel:"訪客對 {trigger} 留下訊息",conversationByOperatorAction:"對話",conversationByOperatorLabel:"{name} 開始對話",conversationByVisitorAction:"對話",conversationByVisitorLabel:"訪客對 {name} 開始對話",conversationByTriggerAction:"對話",conversationByTriggerLabel:"{name} 與系統自動回覆對話",closeChatAction:"關閉對話視窗",closeChatLabel:"{type}"}}),Locale.inherit("tw","en"),Locale.define("uk","app",{messages:{agentjoin:"{name} приєднався до розмови",
agentleave:"{name} залишив чат",transfer:"Чат було передано {name}"},dialogClose:{title:"Бажаєте закінчити розмову?",yes:"Так",no:"Ні",send:"Так, та надіслати зміст чату на e-mail"},dialogSend:{title:"Надіслати розмову на e-mail",email:"E-mail",yes:"Надіслати",no:"Відмінити"},dialogRating:{title:"Як би Ви оцінили чат?",cancel:"Я не хочу давати оцінку",submit:"Надіслати",commentTitle:"Ваш коментар"},online:{title:"Підтримка",infoTitle:"Живий чат",infoDesc:"Запитайтесь нас про що завгодно",maximize:"Максимілізувати",minimize:"Мінімілізувати",hideTitle:"Приховати чат",closeTitle:"Закрити чат",settingsTitle:"Налаштування",disableSounds:"Відключити звуки",enableSounds:"Включити звуки",visitor:"Я",send:"Надіслати",textareaPlaceholder:"Напишіть та натисніть <enter> щоб відіслати",typingMsg:"<span>{name}</span> пише...",transcriptSendingTitle:"Надсилання e-mail...",transcriptSendedTitle:"E-mail успішно надіслано"},login:{title:"Увійти в чат",messageLabel:"Ваше запитання",submit:"Почати чат"},offline:{
title:"Надішліть нам повідомлення",notice:"Нас нема на місці в даний момент, проте Ви можете залишити нам повідомлення. Ми відповімо, як тільки це буде можливо.",hideTitle:"Приховати чат",name:"Ім'я",email:"E-mail",message:"Ваше повідомлення",submit:"Надіслати повідомлення",messageRequiredAlert:"Ви не ввели повідомлення",emailRequiredAlert:"Ви не ввели e-mail адресу",emailInvalidAlert:"Неправильний e-mail",sendInfo:"Надсилання e-mail...",successTitle:"Дякуємо за Ваше повідомлення",successDesc:"Ваше повідомлення було успішно надіслано. Незабаром ми з Вами зв'яжемось.",failureTitle:"Помилка",failureDesc:"Ваше повідомлення не було надіслано.",number:"Телефон"},widget:{online:"Онлайн",away:"Нема на місці",offline:"Оффлайн"},banner:{bubble:{text:"Ми готові до Ваших запитань"},arrow:{title:"Маєте запитання?",desc:"Ми готові відповісти"}},button:{title:"Живий чат"},events:{visitorSendMessageAction:"Гість надіслав повідомлення",visitorSendMessageLabel:"гість надіслав повідомлення",operatorSendMessageAction:"Оператор надіслав повідомлення",
operatorSendMessageLabel:"{name} надіслав повідомлення",triggerSendMessageAction:"Тригер надіслано",triggerSendMessageLabel:"тригер {trigger} написав",visitorReplyTriggerAction:"Гість відповів тригеру",visitorReplyTriggerLabel:"гість відповів тригеру {trigger}\n",conversationByOperatorAction:"Розмова",conversationByOperatorLabel:"{name} розпочав чат",conversationByVisitorAction:"Розмова",conversationByVisitorLabel:"гість почав розмову з {name}",conversationByTriggerAction:"Розмова",conversationByTriggerLabel:"{name} чатував з тригером",closeChatAction:"Закрити чат",closeChatLabel:"{type}"}}),Locale.inherit("uk","en"),Locale.define("cs","plugins",{autoclose:{description:"Pokud nenapíšete žádnou zprávu v průběhu tohoto času, chat bude automaticky ukončen.",emptyText:"Pokud nenapíšete žádnou zprávu v průběhu 5 min, chat bude automaticky ukončen.",closedIdleText:"Poslední komunikace byla ukončena z důvodu neaktivity."}}),Locale.inherit("cs","en");